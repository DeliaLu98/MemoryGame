...
public class TileView extends FrameLayout {
	...
	public class FlipAnimation extends Animation {
		...
		/**
		 * creeaza o animatie 3d de flip intre view uri
		 * 
		 *     @param fromView
		 *            primul view din tranzitie
		 * @param toView
		 *            al doilea
		 */
		...
		protected void applyTransformation(float interpolatedTime, Transformation t) {
			// se invarte in jurul axei y a rotatie
			// calculat in radiani si grade
			final double radians = Math.PI * interpolatedTime;
			float degrees = (float) (180.0 * radians / Math.PI);

			// cand am ajuns la punctul de mijloc
			// trebuie sa ascundem view-ul initial si sa schimbam
			// unghiul cu 180 grade ca sa nu se intoarca din nou view-ul initial
